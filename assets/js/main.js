const firebaseConfig = {
    apiKey: "AIzaSyBnHIW_ZxVGzoT9l9bUuqN2vmoj6Nd2OYU",
    authDomain: "personal-chef-mc-887c6.firebaseapp.com",
    databaseURL: "https://personal-chef-mc-887c6-default-rtdb.firebaseio.com",
    projectId: "personal-chef-mc-887c6",
    storageBucket: "personal-chef-mc-887c6.appspot.com",
    messagingSenderId: "709067314335",
    appId: "1:709067314335:web:6058f13f35ca4cda46beaa"
...
function submitForm(e) {
  ...
  var newt = getElementVal("newt");
  var lname = getElementVal("lname");
  var telephone = getElementVal("telephone");

  

  saveMessages( emailid, subject, message,newt,lname,telephone);
...
const saveMessages = (emailid, subject, message,newt,lname,telephone) => {
...
var people = getElementValue("people");
var location = getElementValue("location");
